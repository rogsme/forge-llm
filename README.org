...
**** Setup with auth-source for API keys
:PROPERTIES:
:ID:       7a8b9c0d-1e2f-3a4b-5c6d-7e8f9a0b1c2d
:END:

For better security, use Doom's built-in auth-source support:
...
3. Store your API key in ~.authinfo~ or ~.authinfo.gpg~:
#+begin_src
...
You can add custom keybindings in your ~config.el~:
...
This adds the following keybindings in Doom's localleader style:
